                    ...
                    <tr class="text-center">
                      ...
                      <td>
                        ...
                        $progress_saya = $Man_sarprasM->get_progress_barang_by_id($barang->kode_item_pengajuan, $data_diri->no_identitas);
                          ...
                          if($progress_saya == 1){?>
                             <a href="#myModal2" id="custId" data-toggle="modal" data-id="<?php echo $barang->kode_item_pengajuan;?>" data-toggle="tooltip" title="Aksi" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span></a>
                          <?php
                          }else{?>
